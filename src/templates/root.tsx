		...
		<>
			<PageLayout>
				<div className='grid grid-cols-1 p-2 md:p-4 lg:p-6 gap-2 md:grid-cols-2 bg-bg h-max  lg:grid-cols-2  '>
					<div className=' py-10 xl:mt-[5rem] lg:mt[2rem] lg:w-[600px]  xl:w-[664px] xl:pl-2 mx-auto max-w-[90rem] xl:px-6 large:px-0 large:pr-0 large:pl-[42px] extraLarge:pl-[103px] extraLarge:mt-[5rem]   lg:pr-[8rem]'>
